...
Personnes = "Encodages.json"
print(f"Écriture dans le fichier : {Personnes}")
with open(Personnes, "w") as json_file:
    json.dump(encodings_dict, json_file)
print(f"Les encodages ont été sauvegardés dans {Personnes}")